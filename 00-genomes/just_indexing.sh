...
sbatch --parsable \
    ...
    --wrap="../00-rcode/gene_names_from_gtf.sh $annotations > $base_ref_name.$release.gene_name_mapping.txt"

# Make link to specified gene name mapping file
ln -s $base_ref_name.$release.gene_name_mapping.txt gene_name_mapping.txt
