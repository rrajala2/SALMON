...
#
# Create differential expression results using DESeq2.
#
# Usage:
#
# Rscript deseq2.r counts.txt patternA patternB
# Said patterns in column headers identify corresponding sample replicates
#
# Produces CSV file differential expression rows printed to the standard output.
#
...
count_file <- args[1] # Counts file
nameA <- args[2] # Assuming this is the Control
nameB <- args[3] # Experiment group name
