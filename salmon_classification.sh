...
function usage() {
    ...
    Usage: $0 --control <TEXT> --condition <TEXT> --fastq-dir <DIR> --ids-file <FILE> --transcripts <FILE> [--is-single (T|F) ] [--run-fastq-qc (T|F) ]
    ...
    Example:
        $0 --ids-file ids.txt --control BORED --condition EXCITED --transcripts 00-genome/transcripts.fa --fastq-dir 00-reads
